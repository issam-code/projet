                    ...
                    <li>
                     ...
                     <div class="modal" id="del_<?php echo $row['id_utilisateur']; ?>">
                         <div class="col-md-3 container my-5" style="background-color:whitesmoke;     width: 350px; height: 150px;">
                             ...
                             <form class="frmm" action="del_etud_pr.php?del=<?php echo $row['id_utilisateur'];?>" method="post">                                             
                             <center>
                                  <h6>Confirmation de Suppression</h6>
                                  <br>
                                  <button style="text-align: center;" type="submit" name="btn2" class="btn btn-primary col-md-5 ">Supprimer</button>
                              </center>
                                         </form>
                             </div><br>
                        </div>
