...
<body id="page-top">
            ...
            <div class="sidebar-brand-icon ">
                                ...
                                <div class="container"><center><img class="img-profile rounded-circle" src="images/<?php foreach ($t as $row) { echo $row['image'];}?>" width="60%"></center></div><br>
                                    <span class="sidebar-brand-text mx-3" style="color:white;"><center><h4><?php foreach ($t as $row) { echo $row['nom'] ." " .$row['prenom'];}?></h4></center></span>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="home_etud.php">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="cours_etud.php"> Cours</a>
                        <a class="collapse-item" href="taches_etud.php">Taches</a>
                        <a class="collapse-item" href="groupe_etud.php">Etudiants</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <a class="collapse-item" href="#profil"  data-toggle="modal"><i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>Profile</a>
                        <a class="collapse-item " href="#deconnect" data-toggle="modal" data-target="#deconnect">
