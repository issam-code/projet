...
<body id="page-top" style="  background-color: #b3bfcc5c;">
    ...
    <!-- Page Wrapper -->
        ...
        <div class="row  " style="padding:10px;   padding-top: 100px;  padding-bottom: 50px;">
                <button type="button" class="btn btn-primary col-md-2  container" data-toggle="modal" data-target="#add_cour">
                Ajouter cour
                </button>
    ...
    <table id="tab" class="table">
        ...
        <tbody>
            <?php
                include 'cnx.php';
                $sql = "select * from cours where id_utilisateur=".$_SESSION["id"]." ORDER BY date_cour DESC";
                $t=$con->query($sql);
                $a=1;  
                foreach ($t as $row) { 
            ?>
                ...
                <td><a data-toggle="modal" data-target="#del_<?php echo $row['id_cour']; ?>" href="gere_cour.php?del=<?php echo $row['id_cour']; ?>"><i class="fas fa-trash"></i></a>
